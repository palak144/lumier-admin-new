...
var EventService = /** @class */ /*@__PURE__*/ (function () {
    ...
    EventService.prototype.getEvent = function (page) {
        ...
        return this.http.get(this.baseUrl + 'eventList', { params: params }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.errorHandler.handleError));
    };
    ...
    EventService.prototype.updateStatus = function (data) {
        return this.http.put(this.baseUrl + 'eventStatus/', data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.errorHandler.handleError));
    };
